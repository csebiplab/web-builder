...
export async function GET(req: Request) {
  ...
  try {
    ...
    return jsonResponse(
      res,
      responseMessageUtilities.projectFetchSuccess,
    ...
    return jsonResponse(
      { error: "Internal Server Error" },
      responseMessageUtilities.projectFetchError,
      responseMessageUtilities.error,
      500
    );
  }
}
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return jsonResponse(
      null,
      responseMessageUtilities.projectDeleteSuccess,
      responseMessageUtilities.success,
      200
    );
  } catch (error) {
    return jsonResponse(
      { error: "Internal Server Error" },
      responseMessageUtilities.projectDeleteError,
      responseMessageUtilities.error,
      500
    );
  }
